...
pub const TU_CAPABILITIES: u64 = TU_CAP_FLEX | TU_CAP_GRID | TU_CAP_BLOCK | TU_CAP_FLOAT | TU_CAP_CALC | TU_CAP_CONTENT_SIZE | TU_CAP_DETAILED_GRID | TU_CAP_CACHED_MEASUREMENT | TU_CAP_THREAD_LOCAL_CONTEXTS | TU_CAP_PANIC_UNWIND_GUARD;
