...
WEB_LINK_HARNESS = ROOT / "native" / "web" / "link_harness.c"
WEB_LINK_HARNESS_DIR = ROOT / ".build" / "web-link-harness"
WEB_UNITY_EMSCRIPTEN_ROOT_ENV = "TAFFYUGUI_UNITY_EMSCRIPTEN_ROOT"
